...
library(boa)
source('plot_R.r')
dat = read.table("fkMcavDepth.baye_fst.txt",header=T)
head(dat)
table(dat[,"qval_g"]<0.1)
outsDepth=which(dat[,"qval_g"]<0.1)
plot_bayescan("fkMcavDepth.baye_fst.txt",FDR=0.1,add_text=F,size=0.5,highlight=outsDepth)
...
write.csv(x=outsAnno, file="annotedOutliersDepth.csv")
```