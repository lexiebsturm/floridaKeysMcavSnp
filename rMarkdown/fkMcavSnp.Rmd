...
ggsave("../figures/figure1.eps", plot=fkMap, height = 20, width = 25, unit = "cm", dpi = 300)
```
...
ggsave("../figures/figure2.eps", plot = fkSnpPcoaPlot, height = 5, width = 7, units = "in", dpi = 300)
